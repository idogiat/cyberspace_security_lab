...
LOCKOUT_THRESHOLD = CONFIG.get('LOCKOUT_THRESHOLD', 45)
RATE_LIMIT_ATTEMPTS = CONFIG.get('RATE_LIMIT_ATTEMPTS', 10)
RATE_LIMIT_LOCK_SEC = CONFIG.get('RATE_LIMIT_LOCK_SEC', 60)
...
CAPTCHA_THRESHOLD = CONFIG.get('CAPTCHA_THRESHOLD', 20)
